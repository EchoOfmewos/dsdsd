...
Config.TimeSync = "realtime" -- Time Sync | types: cd_easytime, none, realtime
...
Config.Lockpick = { item = "advancedlockpick", remove = false } -- item for lockpicking house

Config.NeedBag = {
    enabled = true, -- if needed to enter the house 
    var = 48, --ID of the bag
...
Config.Tier = {
    ["Low Tier"] = {
        chance = 70, -- change in mission to get this house type
    ...
    ["High Tier"] = {
        chance = 20, -- change in mission to get this house type
        ...
        InsidePositions = {
            ...
            ["Heist storage"] = {
                ...
                Items = {
                    { Item = "weapon_smg", Chance = 30.9, MinCount = 1, MaxCount = 2 },
...
Config.SellShop = {
    ...
    Header = "Sell",
    Items = {
        { label = 'TV', item = 'television', description = "Sell Square TV for: $", price = 700, MinAmount = 1, MaxAmount = 20},
        { label = 'Shoe Box', item = 'shoebox', description = "Sell Shoe Box for: $", price = 200, MinAmount = 1, MaxAmount = 2},
        { label = 'DJ deck', item = 'dj_deck', description = "Sell DJ deck for: $", price = 120, MinAmount = 1, MaxAmount = 20 },
        { label = 'Console', item = 'console', description = "Sell console for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Boombox', item = 'boombox', description = "Sell boombox for: $", price = 350, MinAmount = 1, MaxAmount = 20 },
        { label = 'Bong', item = 'bong', description = "Sell bong for: $", price = 200, MinAmount = 1, MaxAmount = 20 },
        { label = 'Pogo Statue', item = 'pogo', description = "Sell Art Piece for: $", price = 1100, MinAmount = 1, MaxAmount = 20 },
        { label = 'Flat Television', item = 'flat_television', description = "Sell Flat Television for: $", price = 500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Coffe', item = 'coffemachine', description = "Sell Coffe for: $", price = 200, MinAmount = 1, MaxAmount = 20 },
        { label = 'Hairdryer', item = 'hairdryer', description = "Sell hairdryer for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Phone', item = 'j_phone', description = "Sell Phone for: $", price = 700, MinAmount = 1, MaxAmount = 20 },
        { label = 'Sculpture', item = 'sculpture', description = "Sell sculpture for: $", price = 700, MinAmount = 1, MaxAmount = 20 },
        { label = 'Toiletry', item = 'toiletry', description = "Sell toiletry for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Laptop', item = 'laptop', description = "Sell Laptop for: $", price = 600, MinAmount = 1, MaxAmount = 20 },
        { label = 'Monitor', item = 'monitor', description = "Sell monitor for: $", price = 500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Printer', item = 'printer', description = "Sell Printer for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Watch', item = 'watch', description = "Sell Watch for: $", price = 700, MinAmount = 1, MaxAmount = 20 },
        { label = 'Toothpaste', item = 'toothpaste', description = "Sell toothpaste for: $", price = 100, MinAmount = 1, MaxAmount = 20 },
        { label = 'Soap', item = 'soap', description = "Sell soap for: $", price = 100, MinAmount = 1, MaxAmount = 20 },
        { label = 'Shampoo', item = 'shampoo', description = "Sell shampoo for: $", price = 106, MinAmount = 1, MaxAmount = 20 },
        { label = 'Romantic book', item = 'romantic_book', description = "Sell romantic book for: $", price = 200, MinAmount = 1, MaxAmount = 20 },
        { label = 'Necklace', item = 'necklace', description = "Sell necklace for: $", price = 450, MinAmount = 1, MaxAmount = 20 },
        { label = 'Gold watch', item = 'gold_watch', description = "Sell gold watch for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Gold bracelet', item = 'gold_bracelet', description = "Sell gold bracelet for: $", price = 400, MinAmount = 1, MaxAmount = 20 },
        { label = 'Bracelet', item = 'bracelet', description = "Sell bracelet for: $", price = 400, MinAmount = 1, MaxAmount = 20 },
        { label = 'Earings', item = 'earings', description = "Sell earings for: $", price = 410, MinAmount = 1, MaxAmount = 20 },
        { label = 'Book', item = 'book', description = "Sell book for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Skull Art', item = 'skull', description = "Sell skull for: $", price = 3000, MinAmount = 1, MaxAmount = 20 },
        { label = 'Pencil', item = 'pencil', description = "Sell pencil for: $", price = 150, MinAmount = 1, MaxAmount = 20 },
        { label = 'Notepad', item = 'notepad', description = "Sell notepad for: $", price = 250, MinAmount = 1, MaxAmount = 20 },
    ...
    Ped = {
        ...
        coords = vec4(559.42529296875, -1777.068359375, 32.442646026611, 7.574640750885), 
...
Config.StartMission = {
    ...
    Ped = {
        model = `cs_fbisuit_01`, 
        coords = vec4(160.01, -82.81, 67.72, 68.54), 
    ...
    Vehicle = {    
        ...
        Model = "burrito3",
        SpawnPoints = {
            { Coords = vector3(155.72, -75.36, 67.97), Heading = 338.82, Radius = 3.0 },
            { Coords = vector3(158.54, -68.05, 68.0), Heading = 336.72, Radius = 3.0 }
        }, 
    }
}