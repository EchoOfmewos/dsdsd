...
Config.Framework = {
    ...
    UseOxInv = true, -- For ESX and QBCore. Lets ESX users have item metadata for the Power Saw and the Saw Blade Pack. Otherwise they'd have infinite use.
    Notifications = "okok", -- "okok" | "mythic" | "tnj" | "oxlib" | "qb" | "ESX" | "chat"
    Phone = "", -- "qb" | "gks" | "qs" | "npwd" (Notification instead of email) | ESX users may need to input their own phone system.
    Menu = "oxlib", -- 'oxlib' | 'nh-context' | Otherwise leave blank ("") to use Framework Settings.
    DrawText = "oxlib", -- "oxlib" | "okok" | "psui" | Otherwise leave blank ("") to use Framework Settings.
    Input = "oxlib", -- "oxlib" if using oxlib input, Otherwise leave blank ("") to use Framework Settings.
}
...
Config.SalvageBehaviour = "skillcheck" -- "minigame" : Uses custom-made blade heating minigame | "skillcheck" : Uses the skillcheck mechanic
...
Config.SkillCheck = {
    ...
    Repetition = {min = 1, max = 2}, -- Amount of repetition the skillcheck has.
...
Config.YardWrecks = {
    ...
    ScrapTime = {min = 20, max = 30}, -- Time for players to harvest 1 set of materials.
    ...
    HarvestMaterials = { -- Rarity gets rolled first, and then a random item from that rarity is selected.
        ['common'] = { -- Comon Rolls have a 40% chance of being selected
            {item = 'metalscrap', minQty = 1, maxQty = 5},
            {item = 'aluminum', minQty = 1, maxQty = 5},
            {item = 'steel', minQty = 1, maxQty = 5},
            {item = 'plastic', minQty = 1, maxQty = 5},
            {item = 'glass', minQty = 1, maxQty = 5},
            {item = 'rubber', minQty = 1, maxQty = 5},
            {item = 'copper', minQty = 1, maxQty = 5},
            {item = 'iron', minQty = 1, maxQty = 5},
        },
        ['uncommon'] = { -- Uncommon roles have 30% chance of being selected
            {item = 'metalscrap', minQty = 2, maxQty = 6},
            {item = 'aluminum', minQty = 2, maxQty = 6},
            {item = 'steel', minQty = 2, maxQty = 6},
            {item = 'plastic', minQty = 2, maxQty = 6},
            {item = 'glass', minQty = 2, maxQty = 6},
            {item = 'rubber', minQty = 2, maxQty = 6},
            {item = 'copper', minQty = 2, maxQty = 6},
            {item = 'iron', minQty = 2, maxQty = 6},
        },
        ['rare'] = { -- Rare rolls have 15% chance of being selected
            {item = 'metalscrap', minQty = 4, maxQty = 7},
            {item = 'aluminum', minQty = 4, maxQty = 7},
            {item = 'steel', minQty = 4, maxQty = 7},
            {item = 'plastic', minQty = 4, maxQty = 7},
            {item = 'glass', minQty = 4, maxQty = 7},
            {item = 'rubber', minQty = 4, maxQty = 7},
            {item = 'copper', minQty = 4, maxQty = 7},
            {item = 'iron', minQty = 4, maxQty = 7},
        },
        ['super-rare'] = { -- super-rare rolls have a 10% chance of being selected
            {item = 'cash', minQty = 0, maxQty = 50},
        },
        ['special'] = { -- Spcial rolls have 5% chance of being selected
            {item = 'diamond', minQty = 0, maxQty = 0},
        }
        -- Note : You can edit the Loot Rarity Matrix in sv_extras to modify the chances. 
    },
}

Config.WorldWrecks = { --Options for wrecks that spawn randomly on the island
    TimeBetweenWrecks = {min = 95, max = 120}, -- Time in minutes in between wreck spawns.
    ...
    ['plane'] = { -- Setting for the crashed plane
        ...
        health = {min = 30, max = 55}, -- Plane Wreck Health (Amount of Haversts before the plane depletes)
        HarvestRolls = {min = 2, max = 5}, -- Number of materials stacks given per harvests.
        WreckHash = 2710556893,
        HarvestMaterials = { -- Rarity gets rolled first, and then a random item from that rarity is selected.
            ['common'] = { -- Comon Rolls have a 40% chance of being selected
                {item = 'metalscrap', minQty = 1, maxQty = 2},
                {item = 'aluminum', minQty = 1, maxQty = 2},
                {item = 'steel', minQty = 1, maxQty = 2},
                {item = 'plastic', minQty = 1, maxQty = 2},
                {item = 'glass', minQty = 1, maxQty = 2},
                {item = 'rubber', minQty = 1, maxQty = 2},
                {item = 'copper', minQty = 1, maxQty = 2},
                {item = 'iron', minQty = 1, maxQty = 2},
            },
            ['uncommon'] = { -- Uncommon roles have 30% chance of being selected
                {item = 'metalscrap', minQty = 2, maxQty = 3},
                {item = 'aluminum', minQty = 2, maxQty = 3},
                {item = 'steel', minQty = 2, maxQty = 3},
                {item = 'plastic', minQty = 2, maxQty = 3},
                {item = 'glass', minQty = 2, maxQty = 3},
                {item = 'rubber', minQty = 2, maxQty = 3},
                {item = 'copper', minQty = 2, maxQty = 3},
                {item = 'iron', minQty = 2, maxQty = 3},
            },
            ['rare'] = { -- Rare rolls have 15% chance of being selected
                {item = 'metalscrap', minQty = 2, maxQty = 5},
                {item = 'aluminum', minQty = 2, maxQty = 5},
                {item = 'steel', minQty = 2, maxQty = 5},
                {item = 'plastic', minQty = 2, maxQty = 5},
                {item = 'glass', minQty = 2, maxQty = 5},
                {item = 'rubber', minQty = 2, maxQty = 5},
                {item = 'copper', minQty = 2, maxQty = 5},
                {item = 'iron', minQty = 2, maxQty = 5},
            },
            ['super-rare'] = { -- super-rare rolls have a 10% chance of being selected
                {item = 'cash', minQty = 50, maxQty = 200},
            },
            ['special'] = { -- Spcial rolls have 5% chance of being selected
                {item = 'cash', minQty = 100, maxQty = 300},
            }
        },
...
-- Flight Box Settings 
Config.FlightBox = {
    HandInCoords = vector4(-913.72, -2037.31, 9.4, 205.09),
    Hash = 3705876410,
    Item = "flightbox",
    Reward = {
        Cash = {
...
Config.YardLocations = { -- Possible Spawn locations inside the scrapyard.
    ...
    vector4(-576.54, -1641.61, 19.43, 357.99),
