...
-- Cool Down Time
Config.CooldownTime = 60 -- Time in minutes before you can chop another vehicle
...
Config.ContractCompleteBonus = 2000 -- Bonus for completing a contract
...
Config.ChopShops = { -- Add as many as you need
    ['LS Customs'] = {   -- Name of the Chop Shop - [MUST BE UNIQUE]
        ...
        DropPartsLocation = vector3(736.16247558594, -1082.2192382813, 22.168918609619),
        ...
        -- Tool Locations
        ImpactDriverLocation = vec3(733.28271484375, -1080.2628173828, 22.168928146362),
...
Config.SawVolume = 0.1    -- [0.1 = 10% volume, 1.0 = 100% volume]
Config.ImpactDriverVolume = 0.2
...
Config.LootMin = 55 -- Min amount of items to receive
Config.LootMax = 100 -- Max amount of items to receive
