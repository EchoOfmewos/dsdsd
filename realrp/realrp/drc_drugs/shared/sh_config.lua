...
Config.LocateDealer = {
    enabled = true,
    RequiredItems = {
        { item = "usb3", count = 1, remove = true }, -- Add you hacking usb item from your server or just create one!
    },
...
Config.Pharmacist = {
    ...
    Items = {
        { label = 'Empty Plastic Can', item = 'meth_emptysacid', description = "Buy Empty Plastic Can for: $",
            price = 120, MinAmount = 1, MaxAmount = 10 },
        { label = 'Amoniak', item = 'meth_amoniak', description = "Buy Amoniak for: $", price = 200, MinAmount = 1,
            MaxAmount = 50 },
        { label = 'Syringe', item = 'syringe', description = "Buy Syringe for: $", price = 250, MinAmount = 1,
            MaxAmount = 10 },
        { label = 'Meth Pipe', item = 'meth_pipe', description = "Buy Meth Pipe for: $", price = 50, MinAmount = 1,
            MaxAmount = 10 },
        { label = 'Crack Pipe', item = 'crack_pipe', description = "Buy Crack Pipe for: $", price = 40, MinAmount = 1,
            MaxAmount = 10 },
    },

    Ped = {
        { model = "s_m_m_doctor_01", coords = vec4(180.33, -1638.17, 29.29, 216.36), scenario = "WORLD_HUMAN_SMOKING" },
    },
}
...
Config.Dealer = {
    ...
    Header = "Weed Dealer",
    Items = {
        { label = 'Weed Access Card', item = 'weed_access', description = "Buy Weed Access for: $", price = 3000,
            MinAmount = 1, MaxAmount = 1 },
        { label = 'Weed Papers', item = 'weed_papers', description = "Buy Weed Papers for: $", price = 150, MinAmount = 1,
            MaxAmount = 5 },
        { label = 'Blunt Wraps', item = 'weed_wrap', description = "Buy Blunt wraps for: $", price = 200, MinAmount = 1,
            MaxAmount = 5 },
        { label = 'Plastic Bag', item = 'plastic_bag', description = "Buy Plastic Bag for: $", price = 200, MinAmount = 1,
            MaxAmount = 10 },
    },
    Ped = {
        { model = "s_m_y_dealer_01", coords = vec4(2527.6, 4473.99, 36.04, 325.64), scenario = "WORLD_HUMAN_SMOKING" },
    },
}
...
Config.MedicamentsShop = {
    ...
    Items = {
        ...
        { label = 'Xanax', item = 'xanaxpack', description = "Buy Xanax for: $", price = 2000, MinAmount = 1,
            MaxAmount = 2 },
        { label = 'Ecstasy', item = 'ecstasy', description = "Buy Ecstasy for: $", price = 200, MinAmount = 1,
            MaxAmount = 2 },
    },
    Ped = {
        { model = "s_m_y_dealer_01", coords = vector4(2530.66, 4981.07, 43.97, 8.58), scenario = "WORLD_HUMAN_SMOKING" },
    },
}
...
Config.FlowerShop = {
    ...
    Header = "Flower Shop",
    Items = {
        { label = 'Hammer', item = 'hammer', description = "Buy Hammer for: $", price = 200, MinAmount = 1, MaxAmount = 2 },
        { label = 'Trowel', item = 'trowel', description = "Buy Trowel for: $", price = 200, MinAmount = 1, MaxAmount = 2 },
        { label = 'Scissors', item = 'scissors', description = "Buy Scissors for: $", price = 200, MinAmount = 1,
            MaxAmount = 2 },
        { label = 'Glue', item = 'glue', description = "Buy Glue for: $", price = 200, MinAmount = 1, MaxAmount = 2 },
        { label = 'Baking Soda', item = 'baking_soda', description = "Buy Baking Soda for: $", price = 200, MinAmount = 1,
            MaxAmount = 2 },
    },
    Ped = {
...
Config.Heroin = {
    ...
    Process = {
        ...
        Duration = 10000,
        RequiredItems = {
            { item = "poppyplant", count = 5, remove = true },
            { item = "meth_amoniak", count = 1, remove = true },
            { item = "plastic_bag", count = 1, remove = true },
        },
        AddItems = {
        ...
        Log = "Has proccessed 5x Poppy plant, 1x Amoniak, 1x Plastic bag into 1x heroin"
    },
}
...
Config.Coke = {
    ...
    FigurePackage = {
        ...
        Log = "Has proccessed 1x Empty Action figure, 1x Pure Coke into 1x Coke Figure"
    },
}
...
Config.Drugs = {
    weed_package = { -- Item name
        ...
        ReqPolice = 30, -- Police count
        ReportChance = 100, --Dispatch Chance 0 - 100 %
        MinPrice = 550, -- Min price
        MaxPrice = 850, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 3, -- Max Count
        ProgressBar = "Selling Weed",
        duration = 5500,
        Chance = 30, -- 0 - 100% succes of negotiate for better price
    ...
    meth_bag = { -- Item name
        ...
        ReqPolice = 34, -- Police count
        ReportChance = 100, --Dispatch Chance 0 - 100 %
        MinPrice = 450, -- Min price
        MaxPrice = 1050, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 3, -- Max Count
        Chance = 30, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
    ...
    coke_figure = { -- Item name
        ...
        ReqPolice = 34, -- Police count
        ReportChance = 100, --Dispatch Chance 0 - 100 %
        MinPrice = 405, -- Min price
        MaxPrice = 950, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 3, -- Max Count
        Chance = 30, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
