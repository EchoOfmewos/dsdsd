...
Config.MinPolice = 7
Config.VaultTimer = 1 -- Minutes before vault opens after hack
    ...
    ['pinkcage'] = {
        ...
        ['powerbox'] = {
            ...
            ['hackitem'] = {
                    ['item'] = "basicdecrypter",
                    ['shouldremove'] = {
                        ['remove'] = true, -- false = Don't remove item, all the options under don't matter when false
                        ['type'] = "success", -- Can be "fail", "success" or "both". 
                        ['chance'] = 100, -- Percentage chance it will be removed
                    }
                },
            ['target'] = {
            ...
            [1] = {
                ...
                ['rewards'] = {
                    [1] = {
                        ...
                        ['min'] = 21428, -- Minimum amount to recieve
                        ['max'] = 22000, -- Maximum amount to recieve
                        ['info'] = {
