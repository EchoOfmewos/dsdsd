...
Config.Return_Vehicle = { --This is the price players pay for their vehicle to be returned to their garage if it has despawned or been blown up.
    ...
    method = 'default', --[ 'default' / 'vehicles_data' ] Read below for more info on each on these 2 options.
    default_price = 250, --If 'default' method is chosen, then it will be a set price to return any vehicle. (eg., $500 fee).
    vehiclesdata_price_multiplier = 1 --If 'vehicles_data' method is chosen, the return vehicle price will be a % of the vehcles value. (eg., 1% of a $50,000 car would be a $500 fee).
}
...
Config.Impound = {
    ...
    Impound_Fee = { --This is the price players pay for their vehicle to be unimpounded.
        ...
        default_price = 350, --If 'default' method is chosen, then it will be a set price to unimpounded any vehicle. (eg., $1000 fee).
...
Config.TransferGarage = {
    ...
    transfer_fee = 250 --The cost per vehicle garage transfer ^.
}
...
Config.FakePlates = {
    ...
    item_name = 'fake_plate', --The name of the usable item to add a fake plate.
...
Config.VehicleKeys = {
    ...
    Hotwire = {
        ...
        ActionBar = {
            ...
            [3] = {seconds = 2, size = 15, chances = 1}, --This is the 3rd action bar.
...
--            [1] = {coords = vector3(451.27, -1016.05, 28.48), spawn_coords = vector4(450.19, -1021.18, 28.4, 93.47), distance = 10, garage_type = 'car', method = 'regular'}, --Mission Row PD (cars)
        ...
        ['ambulance'] = {
            ...
            --[1] = {coords = vector3(352.22, -588.03, 74.17), spawn_coords = vector4(352.22, -588.03, 74.17, 74.5), distance = 10, garage_type = 'air', method = 'regular'}, --Pillbox Hospital (helipad)
            --Sandy MEDICAL
            --[2] = {coords = vector3(1808.53, 3677.7, 34.28), spawn_coords = vector4(1805.42, 3681.13, 34.22, 298.45), distance = 10, garage_type = 'car', method = 'regular'}, --Sandy Medical (cars)
            --[3] = {coords = vector3(1830.74, 3634.77, 34.39), spawn_coords = vector4(1830.74, 3634.77, 34.39, 29.63), distance = 10, garage_type = 'air', method = 'regular'}, --Sandy Medical (helipad)
            --[2] = {coords = vector3(224.27981567383, -1665.1220703125, 29.601547241211), spawn_coords = vector4(224.27981567383, -1665.1220703125, 29.601547241211, 318.03604125977), distance = 10, garage_type = 'car', method = 'regular'}, --Sandy Medical (helipad)
        },
    },
...
Config.GangGarages = {
    ...
    Locations = {
        ...
        [1] = {gang = 'quinn', garage_id = 'QuinnFamily', coords = vector3(-450.67, -794.81, 30.54), spawn_coords = vector4(-460.31, -806.63, 30.54, 274.46), distance = 10, garage_type = 'car'}, --GROVE STREET
        [2] = {gang = 'woc', garage_id = 'WOCGang', coords = vector3(-1098.31, -256.04, 37.69), spawn_coords = vector4(-1098.31, -256.04, 37.69, 137.62), distance = 10, garage_type = 'car'},
    },
}
...
Config.Locations = {
...

    {
        ...
        Type = 'car',
        Dist = 10,
        x_1 = -1540.19, y_1 = -404.46, z_1 = 41.99,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = -1540.19, y_2 = -404.46, z_2 = 41.99, h_2 = 319.34,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
    ...
    {
        Garage_ID = 'Alta', --Alta Street
        Type = 'car',
        Dist = 10,
        x_1 = -300.96, y_1 = -987.21, z_1 = 31.08,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = -295.6, y_2 = -982.7, z_2 = 31.08, h_2 = 250.96,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
    ...
    {
        Garage_ID = 'Vinewood Hills', --Alta Street
        Type = 'car',
        Dist = 10,
        x_1 = -72.13, y_1 = 898.03, z_1 = 235.57,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = -66.83, y_2 = 895.09, z_2 = 235.54, h_2 = 114.1,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
    ...
    {
        Garage_ID = 'Pirson Garage', --Alta Street vector4(1886.03, 2592.56, 45.67, 358.19)
        Type = 'car',
        Dist = 10,
        x_1 = 1899.67, y_1 = 2605.33, z_1 = 45.97,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 1886.03, y_2 = 2592.56, z_2 = 45.67, h_2 = 358.19,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
	...
	{
        Garage_ID = 'MRPD', --PALETO
        Type = 'car',
        Dist = 6,
        x_1 = 442.59, y_1 = -1014.17, z_1 = 28.63,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 442.59, y_2 = -1014.17, z_2 = 28.63, h_2 = 86.64,
        EnableBlip = true,
    ...
    {
        Garage_ID = 'RHPD', --PALETO
        Type = 'car',
        Dist = 6,
        x_1 = -378.41, y_1 = -340.22, z_1 = 24.76,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = -378.41, y_2 = -340.22, z_2 = 24.76, h_2 = 79.18,
        EnableBlip = true,
        JobRestricted = {'police'},
        ShellType = '10cargarage_shell',
    },
	...
	{
        Garage_ID = 'SANDY PD', --SandyPD
        Type = 'car',
        Dist = 6,
        x_1 = 1823.06, y_1 = 3693.64, z_1 = 33.97,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 1823.06, y_2 = 3693.64, z_2 = 33.97, h_2 = 299.91,
        EnableBlip = true,
        JobRestricted = {'police'},
        ShellType = '10cargarage_shell',
    },
    ...
    {
        Garage_ID = 'Hospital', --PALETO
        Type = 'car',
        Dist = 6,
        x_1 = 295.59, y_1 = -605.34, z_1 = 43.23,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 295.59, y_2 = -605.34, z_2 = 43.23, h_2 = 69.91,
        EnableBlip = true,
        JobRestricted = {'ambulance', 'police'},
        ShellType = '10cargarage_shell',
    },
    
    {
        Garage_ID = 'Davis FD', --PALETO
        Type = 'car',
        Dist = 6,
        x_1 = 227.7, y_1 = -1660.70, z_1 = 29.47,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 227.7, y_2 = -1660.70, z_2 = 29.27, h_2 = 316.26,
        EnableBlip = true,
        JobRestricted = {'ambulance', 'police'},
        ShellType = '10cargarage_shell',
    },
...
Config.ImpoundLocations = { --DO NOT CHANGE THE TABLE IDENTIFIERSs, for example - ['car_2'], if you wish to add more, then name the next one ['car_3']. It must have either 'car'/'boat'/'air' in the name and also be unique.
    ['car_1'] = {
        ...
        coords = {x = -141.83, y = -1176.9, z = 23.77}, --This is the location of the garage, where you press e to open for example.
        spawnpoint = {x = -141.83, y = -1176.9, z = 23.77, h = 85.57}, --This is the location where the vehicle spawns.
        blip = {
