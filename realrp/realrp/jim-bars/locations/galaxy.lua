...
Config.Locations["galaxy"] = {
    ...
    Targets = {
        ...
        Storage = {
            { coords = vector3(355.5, 280.56658935547, 94.191886901855), h = 174.0, l = 0.5, w = 0.5, bottom = 29.06, top = 29.66, prop = false },--
            { coords = vector3(353.49041748047, 287.63525390625, 91.191505432129), h = 174.0, l = 1.5, w = 1.5, bottom = 29.06, top = 29.66, prop = false },--
