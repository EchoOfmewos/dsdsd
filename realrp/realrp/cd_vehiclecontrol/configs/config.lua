...
Config.Language = 'EN' --[ 'EN' / 'NL' ]   You can add your own locales to Locales.lua, but be sure to update the Config.Language to match it.
...
Config.Liveries = {
    ...
    Job_Restricted = {
        ENABLE = true, ----Do you want the vehicle liveries feature to only be usable by certain jobs?
...
Config.PreventAutoSeatShuffle = true --Do you want to prevent the auto seat shuffle in the vehicle?
...
Config.OpenUI = {
    ENABLE = false, --Do you want to allow player's open the vehicle control UI?
