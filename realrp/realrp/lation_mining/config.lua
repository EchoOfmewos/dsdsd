...
Config.Selling = {
    ...
    account = 'cash' -- The account to receive money in when selling materials
}
...
Config.SmeltingOptions = {
    nothing = { -- The item name itself
        label = 'Nothing', -- The item "label" / not the item name
