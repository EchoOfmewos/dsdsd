Config.Locations["DPSGTA"] = {
    ...
    Toy = {
        ...
        slots = 1,
        items = {
            { name = 'clucktoy', price = 5, amount = 10, info = {}, type = 'item', slot = 1, },
        },
    },
    ...
    Items = {
        ...
        slots = 12,
        items = {
            { name = 'tomato', price = 5, amount = 200, info = {}, type = 'item', slot = 1, },
            { name = 'potato', price = 5, amount = 200, info = {}, type = 'item', slot = 2, },
            { name = 'onion', price = 5, amount = 200, info = {}, type = 'item', slot = 3, },
            { name = 'lettuce', price = 5, amount = 200, info = {}, type = 'item', slot = 4, },
            { name = 'cheese', price = 5, amount = 200, info = {}, type = 'item', slot = 5, },
            { name = 'rawchickenbreast', price = 5, amount = 200, info = {}, type = 'item', slot = 6, },
            { name = 'frozennugget', price = 5, amount = 200, info = {}, type = 'item', slot = 7, },
            { name = 'rawchickenwing', price = 5, amount = 200, info = {}, type = 'item', slot = 8, },
            { name = 'burgerbun', price = 5, amount = 200, info = {}, type = 'item', slot = 9, },
            { name = 'strawberry', price = 5, amount = 200, info = {}, type = 'item', slot = 10, },
            { name = 'chocolate', price = 5, amount = 200, info = {}, type = 'item', slot = 11, },
        },
    },
    Targets = {
        Storage = {
        ...
        Fryer = {
            { coords = vec3(-521.18, -701.36, 32.17),  l = 1.75, w = 0.9, heading = 90, craftable = Crafting.Fryer },
        },
        ChoppingBoard = {
            { coords = vec3(-521.3, -699.78, 32.17), l = 0.6, w = 1.5, heading = 90, prop = true, propcoords = vec3(-521.3, -699.78, 34.10), craftable = Crafting.ChopBoard, craftable2 = Crafting.Prepare },
        },
         Sink = {
            { coords = vec3(-512.68, -702.74, 33.17), l = 0.6, w = 0.6, heading = 180},
        },
       IceCream = { 
            { coords = vec3(-514.46, -699.18, 33.17), l = 1.0, w = 1.0, heading = 180, craftable = Crafting.IceCream },
        },
       --[[  Prepare = {}, ]]
    },
}
