...
for _, Location in pairs(Config.Locations) do
	if Location.zoneEnabled and Location.tablesEnabled then
        ...
        elseif Location.MLO == "GN" then
            tablelist[#tablelist+1] = { coords = vector3(-148.93, -257.22, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-145.8, -258.18, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-144.03, -255.16, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-143.11, -257.42, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-144.14, -260.43, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-146.28, -261.75, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-148.95, -260.78, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-147.68, -254.26, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-150.97, -253.13, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-152.08, -256.08, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-153.93, -252.14, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-157.05, -254.83, 43.6)}
            tablelist[#tablelist+1] = { coords = vector3(-163.08, -254.74, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-164.11, -257.69, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-158.5, -254.34, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-155.37, -258.73, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-152.51, -259.81, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-150.43, -258.64, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-149.59, -255.68, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-151.23, -253.03, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-154.01, -252.09, 47.8)}
            tablelist[#tablelist+1] = { coords = vector3(-154.08, -255.91, 47.8)}
