...
RegisterNetEvent('av_laptop:chargeStation', function(station)
    ...
    TriggerEvent("inventory:client:SetCurrentStash", station)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", station, {
        maxweight = Stations[station]['maxWeight'],
        slots = Stations[station]['slots'],
    })
end)
...
RegisterNetEvent('av_laptop:openResetStash', function()
    ...
    TriggerEvent("inventory:client:SetCurrentStash", currentStation)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", currentStation, {
        maxweight = Stations[currentStation]['maxWeight'],
        slots = Stations[currentStation]['slots'],
    })
end)