Shared = {
    ...
    Inventory = 'ox_inventory', -- its only ox_inventory, qs-inventory and chezza for now [its used for registering and deleting storages you can still edit openInventory function below] leave it empty if you are not using any of these inventories
    ...
    TargetName = 'qtarget', -- folder name of the target [qb-target, qtarget, etc.]
    ...
    PaymentAtemptInterval = 1, -- On how many days trys to charge the player
    ...
    Storages = { -- all storages' polyzones for the eye
       ...
       -- [41] = {coords = vector3(-1624.96, -814.22, 10.01), heading = 320.0, width = 2.2, length = 5.0, minZ=9.01, maxZ=13.01, avaibleTiers = {1, 2, 3}},
        [37] = {coords = vector3(-719.05, -1120.16, 10.66), heading = 304.0, width = 0.4, length = 3.2, minZ=9.76, maxZ=12.16, avaibleTiers = {1, 2, 3}},
        [38] = {coords = vector3(-700.0, -1143.5, 10.81), heading = 40.0, width = 0.4, length = 3.0, minZ=9.76, maxZ=12.16, avaibleTiers = {1, 2, 3}},
        [39] = {coords = vector3(-1361.85, -932.78, 9.71), heading = 304.0, width = 0.4, length = 4.4, minZ=8.86, maxZ=12.46, avaibleTiers = {1, 2, 3}},
        [40] = {coords = vector3(227.42, -1763.23, 28.68), heading = 320.0, width = 0.4, length = 3.0, minZ=27.88, maxZ=30.08, avaibleTiers = {1, 2, 3}},
    },
}