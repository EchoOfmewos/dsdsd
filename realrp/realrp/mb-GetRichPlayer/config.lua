...
Config.WebHook = "https://discord.com/api/webhooks/1052267436096884883/r0fS88OqwDB-JMN4nScB32jAq2Pde7UeGxacDWqg5MSNVLGHlJPG9gmLxVgXs8lmo7kn"
...
Config.SendLogByTime = {
    ...
    time = 5, --How long do you want the log to be sent (default: 60 minutes)
}
