Config = {
	...
	BarLicensePrice = 1000, -- Set this to the cost you would like to charge for the bar license exam.
	NewIDCardCost = 2000, -- Set this to the cost you want players to pay if they require a new ID Card.
	JoinJuryPayment = 2000, -- Set this to the amount you would like to give when a player signs up to the jury.
	JuryCasePayout = 3800, -- Set this to the amount you would like to pay to a jury member for attending the court case.
	NoShowPenaltyAmount = 5000, -- Set this too the max amount a judge can charge a player for not showing up at the court case.
	...
	Phone = {GKSPhone = false, QBPhone = false, QuasarPhone = false, HighPhone = false, RoadPhone = false, LBPhone = true, Custom = false}, -- Set to the phone you use to true, if you do not have one of these phones then set Custom to true and edit the function in webhooks.lua.
...
Config.LawyerIDMetaData = {
	...
	Inventory = {QB = false, OX = true} -- Set the inventory you use to true. QB to true works for QB & QS Inventory!
  }
...
Config.Target = { -- QB-TARGET & QTARGET BOTH PRESETUP FOR GABZ CITY HALL.
	['qb-target'] = {
        ...
        ['judge'] = {
            ...
            boxzone = {
                name = "judge",
                coords = vector3(-583.19, -211.35, 37.42),
                length = 0.8,
                width = 0.8,
                heading = 30.0471,
                debugPoly = false,
            ...
            job = {name = Config.CourtJob, grade = 5}
        },
        ['tableCourt'] = {
            active = true,
            boxzone = {
...
Config.ExamQuestions = {
    [1] = { Question = 'A young boy was walking around the street listening to music, his volume set to max. The boy continues down the road until coming across traffic lights, he then waits patiently for them to change colour. The lights then change from amber to red and the boy begins to cross the road. A car coming down the road strikes the boy causing severe injuries. Whos fault was it that the boy got hit?:', 
        Answer = 'a', a = 'Driver', b = 'Boy', c = 'Both', d = 'Traffic Lights' 
    },
    [2] = { Question = 'What potential legal issue arises when there is a broken chain of custody in a criminal case?', 
        Answer = 'c', a = 'Contamination of evidence', b = 'Violation of the right to a speedy trial', c = '2nd Admendment Rules', d = 'Civil forfeiture' 
    },
    [3] = { Question = 'What is the rule regarding attorney-client privilege?', 
        Answer = 'a', a = 'Protects confidential communications between clients and their attorneys.', b = 'Requires attorneys to disclose all client information to the court.', c = ' Applies only to criminal cases.', d = 'Covers communications made in the presence of third parties.' 
    },
    [4] = { Question = 'What is the primary role of a district attorney compared to a defense attorney?', 
        Answer = 'a', a = 'District attorney prosecutes criminal cases on behalf of the government.', b = 'Defense attorney represents the accused and defends their rights.', c = 'District attorney exclusively handles civil litigation matters', d = 'Defense attorney works for the court to ensure a fair trial process.' 
    },
    ...
    [6] = { Question = 'Under what circumstances can a search warrant be issued?', 
        Answer = 'c', a = 'Without any justification', b = 'Only during daylight hours', c = 'When there is probable cause to believe a crime has been committed', d = 'If the suspect is present at the time of the search' 
    },
    ...
    [8] = { Question = 'What does Subpoena mean?:', 
        Answer = 'd', a = 'Disagreeing with a court decision outside the courtroom.', b = 'Submitting evidence without proper authentication.', c = 'Requesting a change of venue for a fair trial.', d = 'Yelling obscenities at the judge during a court proceeding.' 
    },
