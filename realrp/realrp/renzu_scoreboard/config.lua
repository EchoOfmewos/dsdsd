...
config.Showid = false -- if false only admins can see the id
...
config.whitelistedjobs = {
    [1] = {name = 'mechanic', fa = '<i class="fad fa-car-mechanic"></i>', label = '🔧STO🔧'},
    [2] = {name = 'mudshop', fa = '<i class="fad fa-car-mechanic"></i>', label = '🔧636🔧'},
    [3] = {name = 'quickrepairs', fa = '<i class="fad fa-car-mechanic"></i>', label = '🔧90🔧'},
    [4] = {name = 'lscustoms', fa = '<i class="fad fa-car-mechanic"></i>', label = '🔧529🔧'},
    [5] = {name = 'stormautos', fa = '<i class="fad fa-car-mechanic"></i>', label = '🔧101🔧'},
    [6] = {name = 'police', fa = '<i class="fad fa-siren-on"></i>', label = 'Police'},
    [7] = {name = 'ambulance', fa = '<i class="fas fa-user-md"></i>', label = 'EMS'},
}
...
config.CheckpingOnce = false -- save and check only ping once (more optimized for large city)
