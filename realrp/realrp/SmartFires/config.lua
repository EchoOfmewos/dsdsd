...
main = {
    ...
    foam = {
        enabled = false,-- This will enable foam mode, allowing you to use /foam to spray foam through the hose (particles are the same, but fires will respond differently)
    ...
    automaticFires = {
        ...
        main = {
            ...
            playersPerFire = 2, -- This means that for every 3 players (or below) part of that group/job, we will spawn one fire (ignore this if you aren't using automatic fires)
            frequencyOfFires = {
                min = 1800, 
                max = 1800
            ...
            removeFiresAutomatically = {
                enabled = true,
                timer = 600, -- 15 minutes will lead to the automatic removal of a fire if it is not extinguished already
            },
        },
        ...
        blips = {
            ...
            scale = 1.0,
            shortRange = false,
            routeEnabled = false, -- This sets up a route on the map to the blip
            routeColour = 49,
        },
...
weapons = {
    water = {
        ...
        name = "Hose",
        reduceBy = 0.50, -- This is how powerful it is, lower the number the better
    ...
    extinguisher = {
        ...
        reduceBy = 0.66,  -- This is how powerful it is, lower the number the better
...
fireTypes = {
    ...
    ["chemical"] = {
        ...
        toPutOut = { weapons.extinguisher, weapons.foam,  weapons.water },
        toIncrease = { weapons.waterMonitor, weapons.deckGun },
        multiFlamesAllowed = true, -- This defines if multiple flames are allowed for this fire type
        maximumMultipleFlames = 16, -- This defines the maximum flames allowed for this fire type
        difficulty = 30, -- This is how difficult the fire is to put out (out of 50)
        maximumFireSizeManual = 10.0, -- This is the maximum fire size that can be created using the create fire command
    ...
    ["electrical"] = {
        ...
        toPutOut = {  weapons.water, weapons.extinguisher, weapons.foam },
        toIncrease = { weapons.waterMonitor, weapons.deckGun },
        multiFlamesAllowed = true, -- This defines if multiple flames are allowed for this fire type
        maximumMultipleFlames = 16, -- This defines the maximum flames allowed for this fire type
        difficulty = 30, -- This is how difficult the fire is to put out (out of 50)
