Config = {
	...
	AtomIngredients = {
		...
		slots = 16,
		items = {
			{ name = "burgerpatty", price = 5, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "cheddar", 	price = 5, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "lettuce", 	price = 5, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "tomato", 		price = 5, amount = 50, info = {}, type = "item", slot = 4, },
			{ name = "burgerbun", 	price = 5, amount = 50, info = {}, type = "item", slot = 5, },
			{ name = "hotdogbun", 	price = 5, amount = 50, info = {}, type = "item", slot = 6, },
			{ name = "rawbacon", 	price = 5, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "rawhotdog", 	price = 5, amount = 50, info = {}, type = "item", slot = 8, },
			{ name = "chillimince",	price = 5, amount = 50, info = {}, type = "item", slot = 9, },
			{ name = "butter",		price = 5, amount = 50, info = {}, type = "item", slot = 10, },
			{ name = "potato", 		price = 5, amount = 50, info = {}, type = "item", slot = 11, },
            { name = "chickenbreast",price = 5, amount = 50, info = {}, type = "item", slot = 12, },
			{ name = "breadslice", 	price = 5, amount = 50, info = {}, type = "item", slot = 13, },
		},
	},
	HornyIngredients = {
		label = "Ingredients Storage",
		...
		items = {
			{ name = "burgerpatty", price = 5, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "egg", 		price = 5, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "breadslice", 	price = 5, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "chickenbreast",price = 5, amount = 50, info = {}, type = "item", slot = 4, },
			{ name = "cheddar", 	price = 5, amount = 50, info = {}, type = "item", slot = 5, },
			{ name = "lettuce", 	price = 5, amount = 50, info = {}, type = "item", slot = 6, },
			{ name = "tomato", 		price = 5, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "burgerbun", 	price = 5, amount = 50, info = {}, type = "item", slot = 8, },
			{ name = "rawbacon", 	price = 5, amount = 50, info = {}, type = "item", slot = 9, },
			{ name = "chillimince",	price = 5, amount = 50, info = {}, type = "item", slot = 10, },
			{ name = "butter",		price = 5, amount = 50, info = {}, type = "item", slot = 11, },
			{ name = "potato", 		price = 5, amount = 50, info = {}, type = "item", slot = 12, },
			{ name = "rawsausage", 	price = 5, amount = 50, info = {}, type = "item", slot = 13, },
			{ name = "pickle", 	price = 5, amount = 50, info = {}, type = "item", slot = 14, },
		},
	},
	IceCream = {
		...
		slots = 5,
		items = {
			{ name = "milk", 		price = 5, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "cream", 		price = 5, amount = 50, info = {}, type = "item", slot = 2, },
		},
	},
...
Crafting = {
	AtomGrill = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_make"], bartime = 2000, animDict = "amb@prop_human_bbq@male@base", animNow = "base", flag = 8 },
	...
	AtomChoppingBoard = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_make"], bartime = 2000, animDict = "mp_arresting", anim = "a_uncuff", flag = 8 },
		{ ["slicedtomato"] 			= { ["tomato"] = 1, }, },
		{ ["slicedpotato"] 			= { ["potato"] = 1, }, },
	},
	AtomPrepare = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_make"], bartime = 2000, animDict = "anim@heists@prison_heiststation@cop_reactions", anim = "cop_b_idle", flag = 3 },
		{ ["tripleburger"] 			= { ["burgermeat"] = 3, ["burgerbun"] = 1, ["cheddar"] = 1, ["lettuce"] = 1, ["slicedtomato"] = 1, } },
		{ ["baconcheesemelt"] 		= { ["bacon"] = 2, ["burgermeat"] = 1, ["lettuce"] = 1, ["burgerbun"] = 1, ["cheddar"] = 1, } },
		{ ["chillidog"] 			= { ["hotdogmeat"] = 1, ["hotdogbun"] = 1, ["cheddar"] = 1, ["chillimince"] = 1, } },
		{ ["grilledchicken"] 		= { ["chickenfillet"] = 1, ["breadslice"] = 1, ["slicedtomato"] = 1, }, },
	},
	Coffee = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_pour"], bartime = 2000, animDict = "mp_ped_interaction", anim = "handshake_guy_a", flag = 8 },
		{ ["coffee"] 				= { } },
	},
	AtomDrink = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_pour"], bartime = 2000, animDict = "mp_ped_interaction", anim = "handshake_guy_a", flag = 8 },
	...
	AtomShakes = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_make"], bartime = 2000, animDict = "mp_ped_interaction", anim = "handshake_guy_a", flag = 8 },
		{ ["creamyshake"] 			= { ["butter"] = 1, ["milk"] = 1, ["cream"] = 1, } },
	},
--Hornys--
	HornyGrill = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_make"], bartime = 2000, animDict = "amb@prop_human_bbq@male@base", animNow = "base", flag = 8 },
	...
	HornyDeserts = {
		["anim"] = { bartext = Loc[Config.Lan].progressbar["progress_grab"], bartime = 2000, animDict = "mp_ped_interaction", anim = "handshake_guy_a", flag = 8 },
		{ ["icecone"] 				= { }, },
		{ ["icenugget"]				= { }, },
		{ ["icecake"] 				= { }, },
	},
