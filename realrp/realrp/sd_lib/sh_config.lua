...
Config.Phone = 'qb-phone' -- qb-phone/lb-phone/qs-smartphone/high-phone/npwd-phone/gks-phone/custom -- This is the phone system that will be used for sending emails (or in some cases, notifications)  (In client/cl_utils.lua, you can add your own phone system into the 'custom' field)
