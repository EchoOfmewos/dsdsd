...
Config.OnePercentWorth = 30            -- Means that 1% progress will reward players with $100
...
Config.Clothes = {
    ...
    male = {
        ...
        ["arms"] = {clotheId = 199, variation = 2},
        ["pants"] = {clotheId = 7, variation = 0},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 12, variation = 0},
        ["t-shirt"] = {clotheId = 106, variation = 1},
        ["torso"] = {clotheId = 174, variation = 0},
        ["decals"] = {clotheId = 0, variation = 0},
        ["kevlar"] = {clotheId = 29, variation = 5},
    },

    maleHelmet = { clotheId = 45, variation = 0},
    
    female = {
        ["mask"] = {clotheId = 0, variation = 0},
        ["arms"] = {clotheId = 0, variation = 0},
        ["pants"] = {clotheId = 158, variation = 0},
        ["bag"] = {clotheId = 272, variation = 1},
        ["shoes"] = {clotheId = 154, variation = 0},
        ["t-shirt"] = {clotheId = 450, variation = 1},
        ["torso"] = {clotheId = 397, variation = 2},
        ["decals"] = {clotheId = 0, variation = 0},
        ["kevlar"] = {clotheId = 0, variation = 0},
    },

    femaleHelmet = { clotheId = 0, variation = 7},
}
