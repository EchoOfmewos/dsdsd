...
Config.MinimumPolice = 6 -- Minimum Police Required to start a Run..
Config.CallCopsChance = 100 -- %Chance to alert police
Config.RunCost = 3500 -- How much it will cost to start the run..
...
Config.Cooldown = {
    ...
    EnableGlobalCooldown = true, -- Global Cooldown for everyone.
    GlobalCooldown = 30, -- Minutes
...
Config.ItemReward = "coke_pure" -- Item that it gives out in exchange of Packages.
Config.MaxItemReward = 20 -- Maximum amount of Config.ItemReward you can get per package.
Config.MinItemReward = 10 -- Minimum amount of Config.ItemReward you can get per package.

Config.SpecialRewardChance = 100 -- % 
Config.SpecialItem = { -- Item(s) you can get as a special Reward
    "markedbills"
}

Config.MaxSpecialReward = 4000 -- Maximum amount of Config.SpecialItem you can get.
Config.MinSpecialReward = 2000 -- Minimum amount of Config.SpecialItem you can get.

-- Moneywashing
Config.CleanMoney = false
...
Config.MaxAmount = 3 -- if Config.Amount is set to random, set the maximum amount that can possibly be washed per.

Config.BagChance = 0 -- Marked Bills

Config.BandMaxPayout = 1500 -- Bands
Config.BandMinPayout = 1050
Config.BandChance = 0

Config.RollMaxPayout = 1550 -- Rolls
Config.RollMinPayout = 1050
Config.RollChance = 0

-- NPC Route Spawn
Config.DriveStyle = 39 -- THIS CAN BE CHANGED AT https://www.vespura.com/fivem/drivingstyle/
Config.MaxDeliveries = 3
Config.MinDeliveries = 2
