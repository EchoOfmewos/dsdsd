...
Config = {
    ...
    Compatibility = {
        ...
        Others = {
            ...
            distance = 35.0, -- Distance to speak (when you use pma-voice, modify directly the distance in the commands.lua file of the pma-voice script, for more information please refer to our documentation)
            manageVolume = false, -- Enable or disable the use of the megaphone volume control.
            volume = 0.8,
...
Config.Keys = {
    ...
    SpeakCarKey = 92, -- Key to speak in vehicle
    SpeakCarKeyString = '~INPUT_VEH_PASSENGER_ATTACK~', -- Key string to speak in vehicle
}
