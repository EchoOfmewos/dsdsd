Config = {
	...
	Items = {
		...
		slots = 9,
		items = {
			{ name = 'burgerpatty', price = 5, amount = 200, info = {}, type = 'item', slot = 1, },
			{ name = 'potato', price = 5, amount = 200, info = {}, type = 'item', slot = 2, },
			{ name = 'onion', price = 5, amount = 200, info = {}, type = 'item', slot = 3, },
			{ name = 'frozennugget', price = 5, amount = 200, info = {}, type = 'item', slot = 4, },
			{ name = 'milk', price = 5, amount = 200, info = {}, type = 'item', slot = 5, },
			{ name = 'icecream', price = 5, amount = 200, info = {}, type = 'item', slot = 6, },
			{ name = 'burgerbun', price = 5, amount = 200, info = {}, type = 'item', slot = 7, },
			{ name = 'cheddar', price = 5, amount = 200, info = {}, type = 'item', slot = 8, },
			{ name = 'lettuce', price = 5, amount = 200, info = {}, type = 'item', slot = 9, },
		},
	},
	Locations = {
