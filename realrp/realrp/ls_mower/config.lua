...
Config.mowerSpeed = { 
    ...
    levelUp = 0.7           -- mower speed increases by given number with level up   
...
Config.lawnMowerSpawnOffset = {
    x = 0.5,    -- This value defines offset sideways (left-right)
    y = -8.0    -- This value defines offset straight (front-back)
}
...
Config.doorLockStatus = 1   -- Put a number from the list below to adjust vehicles door lock status
-- CARLOCK_NONE = 0,
-- CARLOCK_UNLOCKED = 1,
-- CARLOCK_LOCKED = 2,
...
Config.targetInteract = {
    distance = 3.5,         -- maximum distance to interact with mower
}
...
Config.vehiclesSpawning = {
    ...
    attachmentOffset = {
        x = 0.0,            -- change where on truck your mower is going attach (offset from the boot)
        y = -1.0,
        z = 0.5,
    },
...
Config.payments = {
    ...
    reward = math.random(10, 13), -- payment for job is from interval [15 to 45]
    bonus = 100,
