...
Config.RadioListVisibilityCommand = "list"         -- Only works if Config.LetPlayersChangeVisibilityOfRadioList is set to true
...
Config.RadioListChangeNameCommand = "radioname"       -- Only works if Config.LetPlayersSetTheirOwnNameInRadio is set to true
...
Config.LetPlayersOverrideRadioChannelsWithName = true  -- Let players change the name of radio channels that are in Config.RadioChannelsWithName => Only works if Config.LetPlayersChangeRadioChannelsName is set to true
...
Config.RadioChannelsWithName = {
    ...
    ["3"] = "Ambulance",                                -- Every channels between 2 and 3 will be named "Ambulance"
}
