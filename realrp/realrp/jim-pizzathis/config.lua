...
Config = {
	...
	WineItems = {
		...
		items = {
			...
			{ name = "rosso", price = 5, amount = 50, info = {}, type = "item", slot = 6, },
		}
	},
	...
	FoodItems = {
		...
		slots = 7,
		items = {
			{ name = "sauce", price = 5, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "pasta", price = 5, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "olives", price = 5, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "basil", price = 5, amount = 50, info = {}, type = "item", slot = 4, },
			{ name = "mozz", price = 5, amount = 50, info = {}, type = "item", slot = 5, },
			{ name = "lettuce", price = 5, amount = 50, info = {}, type = "item", slot = 6, },
			{ name = "pizzmushrooms", price = 5, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "tiramisu", price = 5, amount = 50, info = {}, type = "item", slot = 8, },
			{ name = "gelato", price = 5, amount = 50, info = {}, type = "item", slot = 9, },
			{ name = "medfruits", price = 5, amount = 50, info = {}, type = "item", slot = 10, },
		}
	},
	FreezerItems = {
		label = "Freezer Store",
		slots = 2,
		items = {
			{ name = "meat", price = 15, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "squid", price = 15, amount = 50, info = {}, type = "item", slot = 2, },
		}
	},
}
Crafting = {
