...
local function WarehouseHeist()
    ...
    local dispatchData = {
        message = locale('warehouseheist'),
        codeName = 'warehouseheist',
        code = '10-65',
        icon = 'fas fa-ship',
        priority = 2,
        coords = coords,
...
exports('WarehouseHeist', WarehouseHeist)

local function BobcatHeist()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('bobcatheist'),
        codeName = 'bobcatheist',
        code = '10-65',
        icon = 'fas fa-ship',
        priority = 2,
        coords = coords,
...
exports('BobcatHeist', BobcatHeist)

local function BriefcaseRobbery()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('briefcaserobbery'),
        codeName = 'briefcaserobbery',
        code = '10-65',
        icon = 'fas fa-ship',
        priority = 2,
        coords = coords,
...
exports('BriefcaseRobbery', BriefcaseRobbery)
