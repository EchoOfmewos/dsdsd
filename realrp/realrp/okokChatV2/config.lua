...
Config.AnonymousPrice = 20

Config.AnonymousCooldown = 1 -- in minutes
...
Config.AutoMessages = {
	"Reminder that you won't always end up with a W, Take the L and (JUST HAVE FUN!)",
	"Need Tow? Do /tow [Message]",
	"If there is a clear rule break (Create a ticket in Discordia)",
}
