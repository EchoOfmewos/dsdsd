...
Config.SocietyPorcentage = 10
Config.PercentageForSell = 10
Config.Taxes = { AgencyFee = 5, BankFee = 10, TaxesFee = 10 }
...
Config.MinimumPoliceGrade = 4           -- Set the minimum grade of the police officer to be able to raid a house
