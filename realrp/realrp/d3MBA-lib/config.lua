...
Framework.Target = 'qtarget' -- [ 'qb-target' / 'qtarget' / ox_target = 'qtarget' ] Set the target script name
...
Framework.FuelScript = 'cdn-fuel' -- [ 'LegacyFuel' / 'ox_fuel' / 'cdn-fuel' / 'ps-fuel' / 'lj-fuel' / 'other' ] Set the fuel script name  
...
Framework.PhoneScript = 'other' -- [ 'qb-phone' / 'qs-smartphone' / 'gksphone' / 'other' ] Set the phone script name (phone notifications)
Framework.UseNotificationsScriptForPhoneNotifications = true -- [ true / false ] Set true if you want to use notifications script for phone notifications / mail notifications
