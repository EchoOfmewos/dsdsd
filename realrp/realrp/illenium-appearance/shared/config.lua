...
Config.Stores = {
    {
        type = "clothing",
        coords = vector3(-396.90924072266, -365.63723754883, 25.098804473877),
        size = vector3(4, 4, 4),
        rotation = 45,
        ...
        points = {
            vec3(303.0, -596.0, 43.0),
		    vec3(300.0, -595.0, 43.0),
		    vec3(298.0, -599.0, 43.0),
		    vec3(300.0, -601.0, 43.0),
        }
    },
    {
        type = "clothing",
        coords = vector3(107.78252410889, -1304.748046875, 28.793022155762),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        showBlip = true, -- overrides the blip visibilty configured above for the group
    ...
    {
        type = "clothing",
        coords = vector3(393.29943847656, 277.33703613281, 94.991401672363),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        showBlip = true, -- overrides the blip visibilty configured above for the group
    ...
    {
        type = "clothing",
        coords = vector3(212.48027038574, -1658.474609375, 29.800764083862),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        showBlip = true, -- overrides the blip visibilty configured above for the group
    ...
    {
        type = "clothing",
        coords = vector4(300.36, -598.32, 43.28, 4.5),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        showBlip = true, -- overrides the blip visibilty configured above for the group
    ...
    {
        type = "clothing",
        coords = vector4(462.58, -996.85, 30.69, 126.59),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        showBlip = true, -- overrides the blip visibilty configured above for the group
        ...
        --targetScenario = "" -- overrides the target scenario configure for the group
        points = {
            vec3(460.0, -996.0, 31.0),
		    vec3(459.0, -999.0, 31.0),
		    vec3(464.0, -1000.0, 31.0),
		    vec3(464.0, -996.0, 31.0),
        }
    },
    {
        type = "clothing",
