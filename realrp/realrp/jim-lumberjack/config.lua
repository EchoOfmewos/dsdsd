Config = {
	...
	Locations =  {
		...
		['Saws'] = {
			...
			{ name = "Wood Saw", coords = vec4(-522.32, 5286.87, 74.25, 70.0), sprite = 162, col = 24, disp = 6, scale = 0.7, cat = nil, blipTrue = true, prop = "prop_tablesaw_01" },
			{ name = "Wood Saw", coords = vec4(-525.02, 5279.09, 74.29, 70.0), sprite = 162, col = 24, disp = 6, scale = 0.7, cat = nil, blipTrue = true, prop = "prop_tablesaw_01" },
		},
		['WoodCut'] = {
			...
			{ name = "Wood Cutting", coords = vec4(-483.9, 5321.86, 80.61, 338.15), sprite = 514, col = 0, disp = 6, scale = 0.7, cat = nil, blipTrue = true, prop = "gr_prop_gr_speeddrill_01b" },
		},
		--['Illegal'] = {
		...
		["Debark"] = {
			...
			{ name = "De-Barking", coords = vec4(-475.82, 5305.81, 86.15, 70.0), sprite = 162, col = 36, disp = 6, scale = 0.7, cat = nil, blipTrue = true },
			{ name = "De-Barking", coords = vec4(-516.28, 5272.37, 80.49, 70.0), sprite = 162, col = 36, disp = 6, scale = 0.7, cat = nil,blipTrue = true },
		},
		["Pulper"] = {
...
--Ores and Props
	...
	Items = {
		...
		items = {
			{ name = "powersaw", price = 400, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "water_bottle", price = 020, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "sandwich", price = 20, amount = 250, info = {}, type = "item", slot = 3, },
			{ name = "bandage", price = 80, amount = 100, info = {}, type = "item", slot = 4, },
		},
	},
}
