...
Config.CigarSmoke = 0.80
Config.CigaretteSmoke = 0.35
...
Config.Smoke = { -- Item = 
    {Item = "cubancigar",  Prop = 'prop_cigar_01', Armor = 0, Stress = 15, Size = 20, Type = 'cigar', Time = 120},
    {Item = "davidoffcigar",  Prop = 'prop_cigar_01', Armor = 0, Stress = 15, Size = 20, Type = 'cigar', Time = 120},
    {Item = "redwcig",  Prop = 'ng_proc_cigarette01a', Armor = 0, Stress = 5, Size = 20, Type = 'cigarette', Time = 120},
...
--    {Item = "vape",  Prop = 'ba_prop_battle_vape_01', Armor = 0, Stress = 5, Size = 0, Type = 'vape', Time = 0},
    {Item = "bong",  Prop = 'prop_bong_01', Armor = 5, Stress = 0, Size = 0, Type = 'bong', Time = 0},
    {Item = "og_kush_joint",  Prop = 'prop_sh_joint_01', Armor = 0, Stress = 5, Size = 20, Type = 'joint', Time = 120},
    {Item = "blue_dream_joint",  Prop = 'prop_sh_joint_01', Armor = 0, Stress = 5, Size = 20, Type = 'joint', Time = 120},
    {Item = "purple_haze_joint",  Prop = 'prop_sh_joint_01', Armor = 0, Stress = 5,Size = 20, Type = 'joint', Time = 120},
    {Item = "banana_kush_joint",  Prop = 'prop_sh_joint_01', Armor = 0, Stress = 5, Size = 20, Type = 'joint', Time = 120},
}
