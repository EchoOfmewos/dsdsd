return {
	...
	Components = {
		['at_flashlight'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_M45A1_FLSH`,
					`COMPONENT_AT_AR_BARPFLSH`,
					`COMPONENT_AT_PI_RUGER57FLSH`
				},
				usetime = 2500
			}
		},
		...
		['at_grip'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_AR_PLRAFGRIP`,
					`COMPONENT_AT_AR_LOKAFGRIP`
				},
				usetime = 2500
			}
		},
		...
		['at_clip_extended_rifle'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_ARPISTOL_BOXMAG`,
					`COMPONENT_PLR_CLIP_02`,
					`COMPONENT_BARP_CLIP_02`,
				},
				usetime = 2500
			}
		},
		...
		['at_scope_medium'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_ARPISTOLSCOPE_MEDIUM`,
				},
				usetime = 2500
			}
		},
		...
		['at_clip_drum_pistol'] = {
			label = '50 Round Pistol Drum Mag For (G19X, G19, PD Combat, G40, G18C)',
			type = 'magazine',
			weight = 500,
			client = {
				component = {
					`COMPONENT_GLOCK19X_CLIP_03`,
					`COMPONENT_GLOCK19_CLIP_03`,
					`COMPONENT_COMBATPISTOL_CLIP_03`,
					`COMPONENT_GLOCK40_CLIP_03`,
					`COMPONENT_GLOCK18C_CLIP_03`,
				},
				usetime = 2500
			}
		},
		...
		['at_clip_100_pistol'] = {
			label = '100 Round Mag For (G19X, G40, PDPistol, G40S)',
			type = 'magazine',
			weight = 800,
			client = {
				component = {
					`COMPONENT_GLOCK19X_CLIP_04`,
					`COMPONENT_GLOCK40_CLIP_04`,
					`COMPONENT_COMBATPISTOL_CLIP_04`,
