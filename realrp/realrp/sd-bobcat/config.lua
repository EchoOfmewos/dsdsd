...
-- Map Settings
Config.MLOType = 'gabz' -- 'nopixel' = The preset coordinates for Nopixels (Tobii's) MLO, 'gabz' = The preset coordinates for Gabz's MLO
...
Config.MinimumPolice = 5 -- minimum police to start heist
...
Config.RemoveThermiteOnFail = true
...
Config.KeycardMinigame = 'hacking' -- Choose between 'mhacking', 'hacking', or 'ps-ui' for the third door
...
Config.Crates = {
    smgs = {
        Amount = {100, 125}, -- Amount is randomized between the 1st and 2nd number
        Items = {
            "diamond",
            "blackdiamond",
        }
    ...
    rifles = {
        Amount = {3, 3}, -- Amount is randomized between the 1st and 2nd number
        Items = {
            "weapon_smg", 
            "weapon_compactrifle",
        }
    ...
    ammo = {
        Amount = {200, 400}, -- Amount is randomized between the 1st and 2nd number
        Items = {
            "ammo-9",
            "ammo-rifle",
            "ammo-rifle2",
...
Config.Rewards = {
    weaponChance = 100, -- overall chance of getting any gun-related reward
