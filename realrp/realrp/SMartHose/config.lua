...
main = {
    ...
    itemEnabled = true, -- Set the command to false if this is true
    itemName = "WEAPON_HOSE",
    hoseCommand = {
        enabled = false, -- This enables/disables the hose command
        ...
        QBCore = {
            ...
            checkJob = {
                ...
                jobs = {"police", "ambulance"}, -- A user can have any of the following jobs, meaning you can add different jobs
            },
            checkPermission = {
