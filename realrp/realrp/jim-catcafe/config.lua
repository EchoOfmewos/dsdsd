Config = {
	...
	Items = {
		...
		items = {
			...
			{ name = "flour", price = 5, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "nori", price = 5, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "tofu", price = 5, amount = 50, info = {}, type = "item", slot = 4, },
			{ name = "onion", price = 5, amount = 50, info = {}, type = "item", slot = 5, },
			{ name = "boba", price = 5, amount = 50, info = {}, type = "item", slot = 6, },
			{ name = "mint", price = 5, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "orange", price = 5, amount = 50, info = {}, type = "item", slot = 8, },
			{ name = "strawberry", price = 5, amount = 50, info = {}, type = "item", slot = 9, },
			{ name = "blueberry", price = 5, amount = 50, info = {}, type = "item", slot = 10, },
			{ name = "milk", price = 5, amount = 50, info = {}, type = "item", slot = 11, },
			{ name = "rice", price = 5, amount = 50, info = {}, type = "item", slot = 12, },
			{ name = "sake", price = 5, amount = 50, info = {}, type = "item", slot = 13, },
			{ name = "noodles", price = 5, amount = 50, info = {}, type = "item", slot = 14, },
		},
	},
	Locations = {
		{	zoneEnable = true,
...
Crafting = {
	...
	Coffee = {
		{ ['catcoffee'] = { ['milk'] = 1, ['sugar'] = 1, }, },
		{ ['nekolatte'] = { ['milk'] = 1, ['sugar'] = 1, }, },
