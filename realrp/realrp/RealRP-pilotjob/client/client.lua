...
RegisterNetEvent('bbv-pilot:start', function()
    ...
    print('pilot_job_vehs','Vehicles',Config.Targets.GetPlane.pos,359,18,0.6)
    Wrapper:Blip('pilot_job_vehs','Vehicles',Config.Targets.GetCar.pos,359,18,0.6)
end)
...
function Main:JobSetup(data)
    ...
    self.w:Blip('job_end','Delivery',data.pos,359,1,1.4)
...
function Main:SetupReturn(r_pos)
    ...
    self.w:Blip('job_return','Return Plane',Config.DeliveryLocations[0].pos,359,1,1.4)
