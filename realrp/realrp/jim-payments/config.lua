...
Config = {
	...
	RenewedBanking = true, -- Enable if using Renewed-Banking false if using qbx-management
	...
	CashInLocation = vector4(268.79098510742, 224.00407409668, 106.28213500977, 174.91873168945), -- Default Third Window along in Pacific Bank
	...
	Jobs = {
		...
		['henhouse'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		...
		['bakery'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['vanilla'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['greasetwo'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['grease'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['alvarez'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['lscustoms'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['stopngo'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['stormautos'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['gasmonkey'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['harshop'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['quickrepairs'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['cluckinbell'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.20, },
		['whitewidow'] = { MinAmountforTicket = 50, PayPerTicket = 200, Commission = 0.10, },
		['billiards'] = { MinAmountforTicket = 50, PayPerTicket = 200, Commission = 0.10, },
		['pearl'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
		['galaxy'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
		['mudshop'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
		['slater'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
		['mudshoptwo'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
		['upnatom'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
		['hornys'] = { MinAmountforTicket = 30, PayPerTicket = 50, Commission = 0.10, },
    ...
    CustomCashRegisters = {
	["pearl"] = { -- Player job role restriction
		{ coords = vector4(-1834.1247558594, -1190.0671386719, 14.45821762085, 240.87), prop = false, },
		{ coords = vector4(-1835.099609375, -1191.7325439453, 14.448567390442, 240.87), prop = false, }, -- vector4 to place the till and the way it faces
	},
	["catcafe"] = { -- Player job role restriction
		{ coords = vector4(-584.03, -1061.47, 22.34, 275.15), prop = false, },
		{ coords = vector4(-583.99, -1058.74, 22.34, 275.15), prop = false, }, -- vector4 to place the till and the way it faces
	},	
},
