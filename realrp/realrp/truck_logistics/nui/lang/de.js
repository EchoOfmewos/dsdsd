// To add a new lang file you must declare the file on the last lines of index.html like: <script src="lang/de.js" type="text/javascript"></script>
if (Lang == undefined) {
	var Lang = [];
}
Lang['de'] = {
	...
	drivers_page_fire_button: 'Kündigen',
