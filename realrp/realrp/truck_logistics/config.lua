...
Config.lang = "en"								-- Set the file language [en/br/de]
...
Config.jobs = {
	...
	['price_per_km_min'] = 85,				-- Minimum price per kilometer of the contract
	['price_per_km_max'] = 115,				-- Maximum price per kilometer of the contract
...
Config.driver_jobs = {
	...
	['profit'] = {								-- These are the drivers' earnings for each contract, a random value is generated for each contract
		['min'] = 250,							-- Minimum base profit, this will be the minimum money this driver can generate
...
Config.party = {
	['price_to_create'] = 500,		-- Price to create a party
	['price_per_member'] = 100, 	-- Cost of each additional member
	['max_members'] = 5,			-- Maximum number of members of each group
