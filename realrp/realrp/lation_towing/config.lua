...
Config.StartJobLocation = vec3(-211.92, -1163.54, 22.05) -- The location at which you start the job (and the map blip location)
Config.DeliverLocation = vec3(-237.81571960449, -1180.0263671875, 23.044055938721) -- The location at which you deliver vehicles
...
Config.StartJobPedHeading = 193.95 -- The direction at which the start job ped is facing
Config.SpawnTruckLocation = vector3(-209.10346984863, -1169.2462158203, 23.044052124023) -- The location at which the tow truck spawns to start the job
Config.SpawnTruckHeading = 94.0 -- The direction the tow truck being spawned is facing
Config.EnableCarKeys = false -- This is for ESX/Standalone only, QBCore key system already works even when set to false
Config.MinWaitTime = 0 -- The minimum wait time in minutes for a new job assignment
Config.MaxWaitTime = 0 -- The maximum wait time in minutes for a new job assignment

--[[ Pay Conigs ]]
Config.PayPerDelivery = 250 -- How much the player is paid per delivery completed
...
Config.MinPayPerDelivery = 250 -- If Config.RandomPayPerDelivery = true then what is the minimum pay? (If RandomPay false, ignore this)
Config.MaxPayPerDelivery = 370 -- If Config.RandomPayPerDelivery = true then what is the maxmimum pay? (If RandomPay false, ignore this)
