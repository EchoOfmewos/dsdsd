...
Ingredients = {
	...
	FoodItems = {
		...
		slots = 12,
		items = {
			{ name = "meat", price = 6, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "pasta", price = 6, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "pickle", price = 6, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "fish", price = 6, amount = 50, info = {}, type = "item", slot = 4, },
			{ name = "nachos", price = 6, amount = 50, info = {}, type = "item", slot = 5, },
			{ name = "potato", price = 6, amount = 50, info = {}, type = "item", slot = 6, },
			{ name = "lettuce", price = 6, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "cheddar", price = 6, amount = 50, info = {}, type = "item", slot = 8, },
			{ name = "chocolate", price = 6, amount = 50, info = {}, type = "item", slot = 9, },
			{ name = "orange", price = 6, amount = 50, info = {}, type = "item", slot = 10, },
			{ name = "lime", price = 6, amount = 50, info = {}, type = "item", slot = 11, },
			{ name = "crisps", price = 6, amount = 50, info = {}, type = "item", slot = 12, },
		},
	},
}
Crafting = {
