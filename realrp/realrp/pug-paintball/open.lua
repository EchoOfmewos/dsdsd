...
function OutFitRed()
    if IsPedModel(PlayerPedId(), 'mp_m_freemode_01') then
        ...
        SetPedComponentVariation(PlayerPedId(),5,Config.ReadTeamOutfit['male']['bag'].item,Config.ReadTeamOutfit['male']['bag'].texture) -- bag
        SetPedPropIndex(PlayerPedId(),0,Config.ReadTeamOutfit['male']['hat'].item,Config.ReadTeamOutfit['male']['hat'].texture) -- hat
    elseif IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then
        ...
        SetPedComponentVariation(PlayerPedId(),5,Config.ReadTeamOutfit['female']['bag'].item,Config.ReadTeamOutfit['female']['bag'].texture) -- bag
        SetPedPropIndex(PlayerPedId(),0,Config.ReadTeamOutfit['female']['hat'].item,Config.ReadTeamOutfit['female']['hat'].texture) -- hat
    end
end
...
function OutFitBlue()
    if IsPedModel(PlayerPedId(), 'mp_m_freemode_01') then
        ...
        SetPedComponentVariation(PlayerPedId(),5,Config.BlueTeamOutfit['male']['bag'].item,Config.BlueTeamOutfit['male']['bag'].texture) -- bag
        SetPedPropIndex(PlayerPedId(),0,Config.BlueTeamOutfit['male']['hat'].item,Config.BlueTeamOutfit['male']['hat'].texture) -- hat
    elseif IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then
        ...
        SetPedComponentVariation(PlayerPedId(),5,Config.BlueTeamOutfit['female']['bag'].item,Config.BlueTeamOutfit['female']['bag'].texture) -- bag
        SetPedPropIndex(PlayerPedId(),0,Config.BlueTeamOutfit['female']['hat'].item,Config.BlueTeamOutfit['female']['hat'].texture) -- hat
    end
end
