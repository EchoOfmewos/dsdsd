...
----------
-- DO NOT TOUCH THIS BELOW UNLESS YOU ARE A CUSTOM FRAMEWORK!!
...
----------
----------
Config.InventoryType = 'ox' -- (ak47, ox, qs, lj, ps, qb, neither) What inventory you are using? if you are using a renamed resource you can adjust the event in server.lua "Pug:server:GivePaintballItems".
...
Config.Input = 'ox_lib' -- (ox_lib, ps-ui, qb-input) if you have change the resource name of qb-input you can use there here as well
Config.Menu = 'ox_lib' -- (ox_lib, ps-ui, qb-menu) if you have change the resource name of qb-menu you can use there here as well
----------
----------
Config.UsingLastStand = false -- DO NOT CHANGE THIS UNLESS USING WASABI_AMBULANCE OR AK47_AMBULANCE (this doesnt matter if you are ESX) (MAKE THIS FALSE IF YOU ARE USING WASABI_AMBULANCE OR AK47_AMBULANCE)
...
----------
----------
Config.RedTeamRadio = 352 -- Radio channel the red team gets put on too.
Config.BlueTeamRadio = 351 -- Radio channel the blue team gets put on too.
Config.MinWager = 1 -- minimum bet players can make
...
Config.PaintballBusinessName = "paintball" -- The name of the paintball job that will collect the money of the business.
----------
Config.PedLocation = vector4(-201.7984161377, -1001.4758911133, 28.1455078125, 70.282318115234) -- The location where the ped will be for starting a game if you have Config.UseVrHeadSet to false
...
Config.StartLoc = vector3(-201.77955627441, -1001.4774780273, 28.1455078125) -- if you change your ped location change this (THIS DOESNT MATTER IF Config.UseVrHeadSet IS TRUE)
...
Config.USingZerioRadio = false -- This if for if you are using the Zerio Radio third party script. It fixes being removed from the radio when dying
----------
----------
...
Config.ReadTeamOutfit ={
    ['male'] = {
        ['mask'] = {item = 117, texture = 0},
        ['t-shirt'] = {item = 319, texture = 0},
        ['undershirt'] = {item = 15, texture = 0},
		['arms'] = {item = 7, texture = 0},
		['pants'] = {item = 146, texture = 7},
        ['shoes'] = {item = 132, texture = 7},
        ['bag'] = {item = 0, texture = 0},
        ['hat'] = {item = 0, texture = 0},
    },
    ['female'] = {
        ['mask'] = {item = 152, texture = 1},
        ['t-shirt'] = {item = 315, texture = 0},
        ['undershirt'] = {item = 10, texture = 0},
        ['arms'] = {item = 1, texture = 0},
        ['pants'] = {item = 200, texture = 2},
        ['shoes'] = {item = 149, texture = 7},
        ['bag'] = {item = 0, texture = 0},
        ['hat'] = {item = 0, texture = 0},
    },
}
...
Config.BlueTeamOutfit ={
    ['male'] = {
        ['mask'] = {item = 117, texture = 1},
        ['t-shirt'] = {item = 319, texture = 1},
        ['undershirt'] = {item = 18, texture = 0},
        ['arms'] = {item = 7, texture = 0},
        ['pants'] = {item = 146, texture = 6},
        ['shoes'] = {item = 132, texture = 6},
        ['bag'] = {item = 0, texture = 0},
        ['hat'] = {item = 0, texture = 0},
    },
    ['female'] = {
        ['mask'] = {item = 152, texture = 0},
        ['t-shirt'] = {item = 315, texture = 1},
        ['undershirt'] = {item = 10, texture = 0},
        ['arms'] = {item = 1, texture = 0},
        ['pants'] = {item = 200, texture = 1},
        ['shoes'] = {item = 149, texture = 6},
        ['bag'] = {item = 0, texture = 0},
        ['hat'] = {item = 0, texture = 0},
    },
}
...
Config.WeaponItems = {
	...
	['weapon_stungun'] 				 = {['name'] = 'weapon_stungun', 		 	  	['label'] = 'Taser', 			        ['description'] = 'A weapon firing barbs attached by wires to batteries, causing temporary paralysis'},
	...
	['weapon_flaregun'] 			 = {['name'] = 'weapon_flaregun', 		 	  	['label'] = 'Flare Gun', 		        ['description'] = 'A handgun for firing signal rockets'},
	...
	['weapon_raypistol']			 = {['name'] = 'weapon_raypistol',				['label'] = 'Weapon Raypistol',			['description'] = 'Weapon Raypistol'},
	...
	['trainwreck'] 					 = {['name'] = 'trainwreck', 			  	    ['label'] = 'Trainwreck Plant', 		['description'] = 'weed'},
	['trainwreckbud'] 				 = {['name'] = 'trainwreckbud', 			  	['label'] = 'Trainwreck Bud', 		 	['description'] = 'weed'},
	['trainblunt'] 					 = {['name'] = 'trainblunt', 			  	    ['label'] = 'Trainwreck Blunt', 		['description'] = 'weed'},
	-- Submachine Guns
	...
	['weapon_remotesniper'] 		 = {['name'] = 'weapon_remotesniper', 	 	  	['label'] = 'Remote Sniper', 			['description'] = 'A portable high-precision, long-range rifle'},
	...
	-- Heavy Weapons
	['weapon_rpg'] 					 = {['name'] = 'weapon_rpg', 			      	['label'] = 'RPG', 						['description'] = 'A rocket-propelled grenade launcher'},
	['weapon_grenadelauncher'] 		 = {['name'] = 'weapon_grenadelauncher', 	  	['label'] = 'Grenade Launcher', 		['description'] = 'A weapon that fires a specially-designed large-caliber projectile, often with an explosive, smoke or gas warhead'},
	['weapon_grenadelauncher_smoke'] = {['name'] = 'weapon_grenadelauncher_smoke', 	['label'] = 'Smoke Grenade Launcher', 	['description'] = 'A bomb that produces a lot of smoke when it explodes'},
	['weapon_minigun'] 				 = {['name'] = 'weapon_minigun', 		      	['label'] = 'Minigun', 					['description'] = 'A portable machine gun consisting of a rotating cluster of six barrels and capable of variable rates of fire of up to 6,000 rounds per minute'},
	['weapon_firework'] 			 = {['name'] = 'weapon_firework', 		 	  	['label'] = 'Firework Launcher', 		['description'] = 'A device containing gunpowder and other combustible chemicals that causes a spectacular explosion when ignited'},
	['weapon_railgun'] 				 = {['name'] = 'weapon_railgun', 		 	  	['label'] = 'Railgun', 					['description'] = 'A weapon that uses electromagnetic force to launch high velocity projectiles'},
	['weapon_hominglauncher'] 		 = {['name'] = 'weapon_hominglauncher', 	 	['label'] = 'Homing Launcher', 			['description'] = 'A weapon fitted with an electronic device that enables it to find and hit a target'},
	['weapon_compactlauncher'] 		 = {['name'] = 'weapon_compactlauncher',  	  	['label'] = 'Compact Launcher', 		['description'] = 'A compact grenade launcher'},
	['weapon_rayminigun']			 = {['name'] = 'weapon_rayminigun', 		 	['label'] = 'Weapon Rayminigun',		['description'] = 'Weapon Rayminigun'},
	['weapon_m6ic'] 		         = {['name'] = 'weapon_m6ic', 	 	  	        ['label'] = 'Special Rifle', 			['description'] = 'A lightweight automatic rifle'},
    ['pdsmokegrenade_ammo']          = {['name'] = 'pdsmokegrenade_ammo',           ['label'] = 'PD Smoke Grenade ammo',    ['description'] = 'Ammo for smoke grenades launchers'},
}
----------
----------
