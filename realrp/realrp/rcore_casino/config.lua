Config = {
    ...
    IT_MAIN_EVENT_COOLDOWN = 60 * 10, -- how long until they can play another main event game, in seconds, (def: 60 * 10)
    -- Win chance of horses are based on their odds, however, if you want to make the game more unlucky, lower the win chance:
    IT_LOCAL_RACE_WIN_CHANCE = 30, -- win chance (from 0 to 100), def: 100, 100 means that it's not *unlucky* at all
    ...
    LUCKY_WHEEL_COOLDOWN = (60 * 60 * 0), -- how long players have to wait for their next spin. def: 24 hours (60 * 60 * 24)
    ...
    CASHIER_VIP_PRICE = 800, -- price of the VIP casino membership, def: 50000
    ...
    CASHIER_MULTITASK = false, -- multiple players can use the Cashier at the same time
    ...
    SocietyName = "casino",
    SocietyLimitFromBalance = 100000, -- if society account has less money than this, it will start paying out reduced money, (SocietyLimitPayoutPercentage)
    ...
    --[[
    'default': default, using events, qb-bossmenu/qbx-management for QB, esx_addonaccount:getSharedAccount for ESX
...
Events = {
    ...
    -- use "qb-bossmenu:client:OpenMenu" for qbx-management and "qb-bossmenu:client:openMenu" for qb-bossmenu
