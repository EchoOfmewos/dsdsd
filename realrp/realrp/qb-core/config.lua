...
QBConfig.Server.Discord = "Discord.gg/RealRoleplay" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = { 'god', 'admin', 'mod', 'realrp', 'doorlock' } -- Add as many groups as you want here after creating them in your server.cfg
