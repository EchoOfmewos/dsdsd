...
Config.Companies.Services = {
    ...
    {
        job = "alvarez",
        name = "Alvarez Auto Shop",
        icon = "https://cdn.discordapp.com/attachments/1137721277411508364/1137732379427999744/depositphotos_83556840-stock-illustration-duty-mechanic.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        location = {
            name = "Alvarez Auto Shop",
...
Config.Valet.Price = 350 -- price to get your vehicle
